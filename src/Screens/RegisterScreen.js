// RegisterScreen.js - Updated with Camera + Gallery functionality
...
const RegisterScreen = ({ navigation, route }) => {
      ...
      try {
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.CAMERA,
          {
            ...
            message: "App needs camera access to take profile pictures",
  ...
  const openCamera = async () => {
    ...
    launchCamera(options, (response) => {
      if (response.didCancel) {
        ...
        processSelectedImage(response.assets[0]);
      }
    });
  };
  ...
  const processSelectedImage = (selectedAsset) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Avatar Picker - Enhanced with Camera & Gallery */}
        <TouchableOpacity 
        ...
        >
          {formData.avtar ? (
            ...
            <View style={styles.avatarPlaceholder}>
              ...
              <Icon name="images" size={20} color="#666" style={styles.galleryIcon} />
