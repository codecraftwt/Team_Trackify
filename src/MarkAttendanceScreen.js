...
import FancyAlert from "./Screens/FancyAlert"
...
       
<TouchableOpacity 
  style={[styles.submitButton, (loading || !isPhotoReady || locationLoading || !currentLocationData) && styles.disabledButton]} 
  onPress={handleSubmit} 
  disabled={loading || !isPhotoReady || locationLoading || !currentLocationData}
>
          {loading ? (
...
  },
disabledButton: {
  backgroundColor: '#aaa', // A muted color for disabled state
},
})
