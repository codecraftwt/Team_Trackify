...
//       if (!serverSessionId) {
//         // Start session now requires a mandatory photo upload.
//         // Offline-created sessions cannot be auto-synced without that photo.
//         console.warn(
//           'SyncService: Skipping session creation on server (start photo required):',
...
//         try {
//           // End session now requires a mandatory photo upload.
//           // Without a stored end photo, we cannot auto-end it here.
//           // (Online punch-out uses the updated flow and ends immediately.)
//           console.warn(
//             'SyncService: Skipping end session sync (end photo required):',
//             serverSessionId,
//           );
//         } catch (err) {
